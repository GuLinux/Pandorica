...
std::shared_ptr<Image> MediaThumbnailGenerator::image(int quality, AVFormatContext* pAvContext) const
{
  auto media_duration = media->durationInSeconds();
  auto resolution = media->resolution();
  quality /= 10;
